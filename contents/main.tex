\section{Main Result}
    ...
    In \nameref{devlstm} subsection, the whole development process of \gls{lstm} is described, covering everything from development decisions, training, validation and testing of the neural network and including a discussion of obtained results while comparing them with existing similar work performed previously. 
